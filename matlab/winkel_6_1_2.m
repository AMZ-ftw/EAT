% Aufgabe 6_1_2 P und Q in Abhängigkeit des Zündwinkels
...
legend('P','P1');
title('Wirkleistung in Abhängigkeit vom Zyndwinkel');
xlabel('Winkel [°]');
...
legend('Q','Q1');
title('Scheinleistung in Abhängigkeit vom Zyndwinkel');
xlabel('Winkel [°]');
